...
def layout_configuracion_texto():
    ...
    layout = [
        ...
        [sg.Push(),
         sg.Text('Tiempo límite (seg.): ', key='-TIEMPO_T-',
                 expand_x=True, font=cg.FUENTE_CONFIG, justification='center'),
         sg.Push()],
...
def layout_configuracion_nivel(nivel, nombre_nivel):
    ...
    layout = [
        ...
        [sg.Push(),
         sg.Text(nivel['-TIEMPO_C-'], key='-TIEMPO_T-',
                 expand_x=True, font=cg.FUENTE_CONFIG, justification='center'),
         sg.Push()],

        [sg.Push(),
         sg.Text(nivel['-RONDAS_C-'], key='-RONDAS_T-',
                 expand_x=True, font=cg.FUENTE_CONFIG, justification='center'),
         sg.Push()],

        [sg.Push(),
         sg.Text(nivel['-CORRECTO_C-'], key='-CORRECTO_T-',
                 expand_x=True, font=cg.FUENTE_CONFIG, justification='center'),
         sg.Push()],

        [sg.Push(),
         sg.Text(nivel['-INCORRECTO_C-'], key='-INCORRECTO_T-',
                 expand_x=True, font=cg.FUENTE_CONFIG, justification='center'),
         sg.Push()],

        [sg.Push(),
         sg.Text(nivel['-CARACTERISTICAS_C-'], key='-CARACTERISTICAS_T-',
                 expand_x=True, font=cg.FUENTE_CONFIG, justification='center'),
         sg.Push()]]
    return layout
